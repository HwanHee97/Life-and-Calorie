...
//public void addCommentList(){//댓글리스트 읽어와서 리스트에 추가 하는 함수
//    comment_ArrayList.add(new Community_Comment_Item("a","2021-09-02","user1"));
//    comment_ArrayList.add(new Community_Comment_Item("f","2021-09-04","user2"));
...
public void add_Comment(View v){
    ...
    comment_ArrayList.add(new Community_Comment_Item(comment_et.getText().toString(),today,"사용자123"));
    comment_et.setText("");
    //서버로 댓글,낳짜, 글쓴이 넘겨서 디비에 추가하는 함수 추가예정
}
}
