...
public class CalendarFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tv_weight_goal.setText(pref.getInt("weight",0)+"");
        ...
        tv_present_weight.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                //CustomDialog 객체 생성
                CustomDialog dialogCustom = new CustomDialog(getContext(),dateStr);
        ...
        OnDateSelectedListener onDateSelectedListener = new OnDateSelectedListener() {
            ...
            public void onDateSelected(@NonNull MaterialCalendarView widget, @NonNull CalendarDay date, boolean selected) {
                ...
                Cursor c2 = db.rawQuery("SELECT * FROM WEIGHT WHERE DATE ='" + dateStr + "';",null);
                tv_present_weight.setText("");
                while(c2.moveToNext()){
                    tv_present_weight.setText(c2.getString(1));
                }
