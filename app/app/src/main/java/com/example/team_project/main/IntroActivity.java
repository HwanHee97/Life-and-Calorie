        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (msg.what == PROGRESSBAR_START) {
                ...
                //ProgressBar가 다 채워졌을 때
                    ...
                    Log.i("minhxxk", pref.getString("nickname", "Unknown") + ", " + pref.getInt("weight", 0) + ", " + pref.getInt("calorie", 0));

                    //Preference에 사용자의 닉네임이 공백이 아니고 몸무게가 0이 아닐 경우
                    if (pref.getString("nickname", "") != "" && pref.getInt("weight", 0) != 0 && pref.getInt("calorie", 0) != 0) {
                        //MainActivity 실행
